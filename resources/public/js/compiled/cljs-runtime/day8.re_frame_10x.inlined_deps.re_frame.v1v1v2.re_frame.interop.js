...
return [(function (){var pred__15958 = cljs.core.instance_QMARK_;
var expr__15959 = reactive_val;
if(cljs.core.truth_((pred__15958.cljs$core$IFn$_invoke$arity$2 ? pred__15958.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.RAtom,expr__15959) : pred__15958.call(null,day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.RAtom,expr__15959)))){
return "ra";
} else {
if(cljs.core.truth_((pred__15958.cljs$core$IFn$_invoke$arity$2 ? pred__15958.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.RCursor,expr__15959) : pred__15958.call(null,day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.RCursor,expr__15959)))){
return "rc";
} else {
if(cljs.core.truth_((pred__15958.cljs$core$IFn$_invoke$arity$2 ? pred__15958.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.Reaction,expr__15959) : pred__15958.call(null,day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.Reaction,expr__15959)))){
return "rx";
} else {
if(cljs.core.truth_((pred__15958.cljs$core$IFn$_invoke$arity$2 ? pred__15958.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.Track,expr__15959) : pred__15958.call(null,day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.Track,expr__15959)))){
return "tr";
} else {
return "other";
}
