...
return [(function (){var pred__19690 = cljs.core.instance_QMARK_;
var expr__19691 = reactive_val;
if(cljs.core.truth_((pred__19690.cljs$core$IFn$_invoke$arity$2 ? pred__19690.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__19691) : pred__19690.call(null,reagent.ratom.RAtom,expr__19691)))){
return "ra";
} else {
if(cljs.core.truth_((pred__19690.cljs$core$IFn$_invoke$arity$2 ? pred__19690.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__19691) : pred__19690.call(null,reagent.ratom.RCursor,expr__19691)))){
return "rc";
} else {
if(cljs.core.truth_((pred__19690.cljs$core$IFn$_invoke$arity$2 ? pred__19690.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__19691) : pred__19690.call(null,reagent.ratom.Reaction,expr__19691)))){
return "rx";
} else {
if(cljs.core.truth_((pred__19690.cljs$core$IFn$_invoke$arity$2 ? pred__19690.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__19691) : pred__19690.call(null,reagent.ratom.Track,expr__19691)))){
return "tr";
} else {
return "other";
}
