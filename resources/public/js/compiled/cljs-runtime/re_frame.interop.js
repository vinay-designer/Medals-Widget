...
return [(function (){var pred__19702 = cljs.core.instance_QMARK_;
var expr__19703 = reactive_val;
if(cljs.core.truth_((pred__19702.cljs$core$IFn$_invoke$arity$2 ? pred__19702.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__19703) : pred__19702.call(null,reagent.ratom.RAtom,expr__19703)))){
return "ra";
} else {
if(cljs.core.truth_((pred__19702.cljs$core$IFn$_invoke$arity$2 ? pred__19702.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__19703) : pred__19702.call(null,reagent.ratom.RCursor,expr__19703)))){
return "rc";
} else {
if(cljs.core.truth_((pred__19702.cljs$core$IFn$_invoke$arity$2 ? pred__19702.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__19703) : pred__19702.call(null,reagent.ratom.Reaction,expr__19703)))){
return "rx";
} else {
if(cljs.core.truth_((pred__19702.cljs$core$IFn$_invoke$arity$2 ? pred__19702.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__19703) : pred__19702.call(null,reagent.ratom.Track,expr__19703)))){
return "tr";
} else {
return "other";
}
