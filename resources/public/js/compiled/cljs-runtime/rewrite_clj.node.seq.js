...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__5342__auto__,k23132,else__5343__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k23132,else__5343__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__5363__auto__,p__23141){
var vec__23142 = p__23141;
var k__5364__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23142,(0),null);
var v__5365__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23142,(1),null);
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__23131){
var self__ = this;
var G__23131__$1 = this;
return (new cljs.core.RecordIter((0),G__23131__$1,5,new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"tag","tag",-1290361223),new cljs.core.Keyword(null,"wrap-fn","wrap-fn",-270233130),new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519),new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231),new cljs.core.Keyword(null,"children","children",-940561982)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this23133,other23134){
var self__ = this;
var this23133__$1 = this;
return (((!((other23134 == null)))) && ((((this23133__$1.constructor === other23134.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this23133__$1.tag,other23134.tag)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this23133__$1.wrap_fn,other23134.wrap_fn)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this23133__$1.wrap_length,other23134.wrap_length)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this23133__$1.seq_fn,other23134.seq_fn)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this23133__$1.children,other23134.children)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this23133__$1.__extmap,other23134.__extmap)))))))))))))));
}));
...
var self__ = this;
var this$__$1 = this;
var G__23154 = rewrite_clj.node.protocols.sexprs(self__.children);
return (self__.seq_fn.cljs$core$IFn$_invoke$arity$1 ? self__.seq_fn.cljs$core$IFn$_invoke$arity$1(G__23154) : self__.seq_fn.call(null,G__23154));
}));
...
var self__ = this;
var this$__$1 = this;
var G__23155 = rewrite_clj.node.protocols.concat_strings(self__.children);
return (self__.wrap_fn.cljs$core$IFn$_invoke$arity$1 ? self__.wrap_fn.cljs$core$IFn$_invoke$arity$1(G__23155) : self__.wrap_fn.call(null,G__23155));
}));
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__5347__auto__,k23132){
var self__ = this;
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k23132);

}
}));

(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__5348__auto__,k__5349__auto__,G__23131){
var self__ = this;
var this__5348__auto____$1 = this;
var pred__23157 = cljs.core.keyword_identical_QMARK_;
var expr__23158 = k__5349__auto__;
if(cljs.core.truth_((pred__23157.cljs$core$IFn$_invoke$arity$2 ? pred__23157.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"tag","tag",-1290361223),expr__23158) : pred__23157.call(null,new cljs.core.Keyword(null,"tag","tag",-1290361223),expr__23158)))){
return (new rewrite_clj.node.seq.SeqNode(G__23131,self__.wrap_fn,self__.wrap_length,self__.seq_fn,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__23157.cljs$core$IFn$_invoke$arity$2 ? pred__23157.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"wrap-fn","wrap-fn",-270233130),expr__23158) : pred__23157.call(null,new cljs.core.Keyword(null,"wrap-fn","wrap-fn",-270233130),expr__23158)))){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,G__23131,self__.wrap_length,self__.seq_fn,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__23157.cljs$core$IFn$_invoke$arity$2 ? pred__23157.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519),expr__23158) : pred__23157.call(null,new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519),expr__23158)))){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,G__23131,self__.seq_fn,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__23157.cljs$core$IFn$_invoke$arity$2 ? pred__23157.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231),expr__23158) : pred__23157.call(null,new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231),expr__23158)))){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,self__.wrap_length,G__23131,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__23157.cljs$core$IFn$_invoke$arity$2 ? pred__23157.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"children","children",-940561982),expr__23158) : pred__23157.call(null,new cljs.core.Keyword(null,"children","children",-940561982),expr__23158)))){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,self__.wrap_length,self__.seq_fn,G__23131,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,self__.wrap_length,self__.seq_fn,self__.children,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__5349__auto__,G__23131),null));
}
}
}
}
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__5339__auto__,G__23131){
var self__ = this;
var this__5339__auto____$1 = this;
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,self__.wrap_length,self__.seq_fn,self__.children,G__23131,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.seq.map__GT_SeqNode = (function rewrite_clj$node$seq$map__GT_SeqNode(G__23138){
var extmap__5382__auto__ = (function (){var G__23164 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__23138,new cljs.core.Keyword(null,"tag","tag",-1290361223),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"wrap-fn","wrap-fn",-270233130),new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519),new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231),new cljs.core.Keyword(null,"children","children",-940561982)], 0));
if(cljs.core.record_QMARK_(G__23138)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__23164);
} else {
return G__23164;
}
})();
return (new rewrite_clj.node.seq.SeqNode(new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(G__23138),new cljs.core.Keyword(null,"wrap-fn","wrap-fn",-270233130).cljs$core$IFn$_invoke$arity$1(G__23138),new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519).cljs$core$IFn$_invoke$arity$1(G__23138),new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231).cljs$core$IFn$_invoke$arity$1(G__23138),new cljs.core.Keyword(null,"children","children",-940561982).cljs$core$IFn$_invoke$arity$1(G__23138),null,cljs.core.not_empty(extmap__5382__auto__),null));
});
...
return rewrite_clj.node.seq.__GT_SeqNode(new cljs.core.Keyword(null,"list","list",765357683),rewrite_clj.node.seq.wrap_list,(2),(function (p1__23165_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.list,p1__23165_SHARP_);
}),children);
});
/**
...
return rewrite_clj.node.seq.__GT_SeqNode(new cljs.core.Keyword(null,"map","map",1371690461),rewrite_clj.node.seq.wrap_map,(2),(function (p1__23167_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,p1__23167_SHARP_);
}),children);
});
