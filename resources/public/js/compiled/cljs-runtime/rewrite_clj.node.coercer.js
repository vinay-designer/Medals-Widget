...
return rewrite_clj.node.coercer.node_with_meta((function (){var G__23393 = cljs.core.vec(rewrite_clj.node.whitespace.space_separated(cljs.core.map.cljs$core$IFn$_invoke$arity$2(rewrite_clj.node.protocols.coerce,sq)));
return (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__23393) : f.call(null,G__23393));
})(),sq);
});
...
var comma_23404 = rewrite_clj.node.whitespace.whitespace_node(", ");
var space_23405 = rewrite_clj.node.whitespace.whitespace_node(" ");
rewrite_clj.node.coercer.map__GT_children = (function rewrite_clj$node$coercer$map__GT_children(m){
return cljs.core.vec(cljs.core.butlast(cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p__23395){
var vec__23396 = p__23395;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23396,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23396,(1),null);
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [rewrite_clj.node.protocols.coerce(k),space_23405,rewrite_clj.node.protocols.coerce(v),comma_23404], null);
