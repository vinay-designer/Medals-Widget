...
var G__24010 = (rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1(n) : rewrite_clj.zip.next.call(null,n));
loc = G__24010;
continue;
} else {
var G__24011 = (rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1(loc) : rewrite_clj.zip.next.call(null,loc));
loc = G__24011;
continue;
}
} else {
var G__24012 = (rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1(loc) : rewrite_clj.zip.next.call(null,loc));
loc = G__24012;
continue;
}
}
...
var G__23989 = zloc;
var G__23990 = (function (){var G__23991 = zprint.rewrite.prewalk_subtree(p_QMARK_,f,(function (){var G__23992 = zloc;
var G__23992__$1 = (((G__23992 == null))?null:(rewrite_clj.zip.node.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.node.cljs$core$IFn$_invoke$arity$1(G__23992) : rewrite_clj.zip.node.call(null,G__23992)));
if((G__23992__$1 == null)){
return null;
} else {
return (zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1 ? zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1(G__23992__$1) : zprint.zutil.edn_STAR_.call(null,G__23992__$1));
}
})());
return (rewrite_clj.zip.root.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.root.cljs$core$IFn$_invoke$arity$1(G__23991) : rewrite_clj.zip.root.call(null,G__23991));
})();
return (rewrite_clj.zip.replace.cljs$core$IFn$_invoke$arity$2 ? rewrite_clj.zip.replace.cljs$core$IFn$_invoke$arity$2(G__23989,G__23990) : rewrite_clj.zip.replace.call(null,G__23989,G__23990));
});
/**
...
var G__24015 = (rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1(nloc) : rewrite_clj.zip.down.call(null,nloc));
nloc = G__24015;
continue;
}
break;
...
var G__24019 = (rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1(nloc) : rewrite_clj.zip.right.call(null,nloc));
var G__24020 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,nloc);
nloc = G__24019;
out = G__24020;
continue;
} else {
...
var G__24023 = (rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1(replaced_loc) : rewrite_clj.zip.right.call(null,replaced_loc));
var G__24024 = cljs.core.next(new_loc);
var G__24025 = replaced_loc;
nloc = G__24023;
new_loc = G__24024;
last_loc = G__24025;
continue;
...
return zprint.rewrite.sort_val((function (){var G__24001 = (rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1(zloc) : rewrite_clj.zip.right.call(null,zloc));
return (rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1(G__24001) : rewrite_clj.zip.down.call(null,G__24001));
})());
});
/**
...
var new_dep = zprint.rewrite.prewalk(zloc,(function (p1__24007_SHARP_){
return ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((rewrite_clj.zip.tag.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.tag.cljs$core$IFn$_invoke$arity$1(p1__24007_SHARP_) : rewrite_clj.zip.tag.call(null,p1__24007_SHARP_)),new cljs.core.Keyword(null,"token","token",-1211463215))) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((rewrite_clj.zip.sexpr.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.sexpr.cljs$core$IFn$_invoke$arity$1(p1__24007_SHARP_) : rewrite_clj.zip.sexpr.call(null,p1__24007_SHARP_)),new cljs.core.Keyword(null,"dependencies","dependencies",1108064605))));
