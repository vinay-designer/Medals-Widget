...
var len__5766__auto___14868 = arguments.length;
var i__5767__auto___14869 = (0);
while(true){
if((i__5767__auto___14869 < len__5766__auto___14868)){
args__5772__auto__.push((arguments[i__5767__auto___14869]));

var G__14928 = (i__5767__auto___14869 + (1));
i__5767__auto___14869 = G__14928;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq14772){
...
return self__5751__auto__.cljs$core$IFn$_invoke$arity$variadic(G__14773,G__14774,seq14772__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__14802_SHARP_){
return (!((cljs.core.meta(p1__14802_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14829__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e14830){var _e__11847__auto__ = e14830;
return false;
}})();
if(cljs.core.truth_(or__5043__auto__)){
return or__5043__auto__;
...
}catch (e14832){var _e__11847__auto__ = e14832;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__14834 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__14835 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__14835);
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14836__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__14834);
}});
...
var temp__5802__auto___14944 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5802__auto___14944)){
var managed_print_level_14945 = temp__5802__auto___14944;
var _STAR_print_level_STAR__orig_val__14838_14946 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__14839_14947 = managed_print_level_14945;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__14839_14947);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__14837_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__14837_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__14838_14946);
}} else {
job_fn();
}
