...
var len__5766__auto___14977 = arguments.length;
var i__5767__auto___14978 = (0);
while(true){
if((i__5767__auto___14978 < len__5766__auto___14977)){
args__5772__auto__.push((arguments[i__5767__auto___14978]));

var G__14979 = (i__5767__auto___14978 + (1));
i__5767__auto___14978 = G__14979;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq14760){
...
return self__5751__auto__.cljs$core$IFn$_invoke$arity$variadic(G__14761,G__14762,seq14760__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__14834_SHARP_){
return (!((cljs.core.meta(p1__14834_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14861__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e14862){var _e__11842__auto__ = e14862;
return false;
}})();
if(cljs.core.truth_(or__5043__auto__)){
return or__5043__auto__;
...
}catch (e14868){var _e__11842__auto__ = e14868;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__14947 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__14948 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__14948);
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14951__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__14947);
}});
...
var temp__5802__auto___14990 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5802__auto___14990)){
var managed_print_level_14991 = temp__5802__auto___14990;
var _STAR_print_level_STAR__orig_val__14966_14992 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__14967_14993 = managed_print_level_14991;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__14967_14993);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__14956_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__14956_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__14966_14992);
}} else {
job_fn();
}
