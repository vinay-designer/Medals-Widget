...
var map__11924 = top_item;
var map__11924__$1 = cljs.core.__destructure_map(map__11924);
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11924__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11924__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11924__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error(error.message,file,line,column);
}catch (e11923){var _e = e11923;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5802__auto___11952 = devtools.hints.get_processed_errors_BANG_();
if(cljs.core.truth_(temp__5802__auto___11952)){
var seen_errors_11953 = temp__5802__auto___11952;
if(cljs.core.truth_(seen_errors_11953.has(self))){
} else {
seen_errors_11953.add(self);

var temp__5804__auto___11954 = devtools.hints.error_object_sense(self);
if(cljs.core.truth_(temp__5804__auto___11954)){
var sense_11955 = temp__5804__auto___11954;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_11955)].join(''));
} else {
}
}
} else {
