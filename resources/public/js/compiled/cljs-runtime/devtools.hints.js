...
var map__11988 = top_item;
var map__11988__$1 = cljs.core.__destructure_map(map__11988);
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11988__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11988__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11988__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error(error.message,file,line,column);
}catch (e11987){var _e = e11987;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5802__auto___12015 = devtools.hints.get_processed_errors_BANG_();
if(cljs.core.truth_(temp__5802__auto___12015)){
var seen_errors_12017 = temp__5802__auto___12015;
if(cljs.core.truth_(seen_errors_12017.has(self))){
} else {
seen_errors_12017.add(self);

var temp__5804__auto___12019 = devtools.hints.error_object_sense(self);
if(cljs.core.truth_(temp__5804__auto___12019)){
var sense_12021 = temp__5804__auto___12019;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_12021)].join(''));
} else {
}
}
} else {
