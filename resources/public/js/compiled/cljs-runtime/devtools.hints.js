...
}catch (e11940){var _e = e11940;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5802__auto___11968 = devtools.hints.get_processed_errors_BANG_();
if(cljs.core.truth_(temp__5802__auto___11968)){
var seen_errors_11969 = temp__5802__auto___11968;
if(cljs.core.truth_(seen_errors_11969.has(self))){
} else {
seen_errors_11969.add(self);

var temp__5804__auto___11970 = devtools.hints.error_object_sense(self);
if(cljs.core.truth_(temp__5804__auto___11970)){
var sense_11971 = temp__5804__auto___11970;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_11971)].join(''));
} else {
}
}
} else {
