...
var G__23763 = (function (){var G__23764 = (rewrite_clj.node.sexpr.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.node.sexpr.cljs$core$IFn$_invoke$arity$1(node) : rewrite_clj.node.sexpr.call(null,node));
return (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__23764) : f.call(null,G__23764));
})();
return (rewrite_clj.node.coerce.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.node.coerce.cljs$core$IFn$_invoke$arity$1(G__23763) : rewrite_clj.node.coerce.call(null,G__23763));
});
/**
...
var len__5766__auto___23777 = arguments.length;
var i__5767__auto___23778 = (0);
while(true){
if((i__5767__auto___23778 < len__5766__auto___23777)){
args__5772__auto__.push((arguments[i__5767__auto___23778]));

var G__23779 = (i__5767__auto___23778 + (1));
i__5767__auto___23778 = G__23779;
continue;
} else {
}
break;
...
return clojure.zip.edit.cljs$core$IFn$_invoke$arity$variadic(zloc,rewrite_clj.zip.editz.edit_node,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(function (p1__23765_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$3(f,p1__23765_SHARP_,args);
})], 0));
}));
...
/** @this {Function} */
(rewrite_clj.zip.editz.edit.cljs$lang$applyTo = (function (seq23766){
...
return self__5751__auto__.cljs$core$IFn$_invoke$arity$variadic(G__23767,G__23768,seq23766__$2);
}));
...
var e_SINGLEQUOTE_ = ((typeof e === 'string')?(str_fn.cljs$core$IFn$_invoke$arity$1 ? str_fn.cljs$core$IFn$_invoke$arity$1(e) : str_fn.call(null,e)):(((e instanceof cljs.core.Keyword))?cljs.core.keyword.cljs$core$IFn$_invoke$arity$2(cljs.core.namespace(e),(function (){var G__23769 = cljs.core.name(e);
return (str_fn.cljs$core$IFn$_invoke$arity$1 ? str_fn.cljs$core$IFn$_invoke$arity$1(G__23769) : str_fn.call(null,G__23769));
})()):(((e instanceof cljs.core.Symbol))?cljs.core.symbol.cljs$core$IFn$_invoke$arity$2(cljs.core.namespace(e),(function (){var G__23770 = cljs.core.name(e);
return (str_fn.cljs$core$IFn$_invoke$arity$1 ? str_fn.cljs$core$IFn$_invoke$arity$1(G__23770) : str_fn.call(null,G__23770));
})()):null)));
...
var G__23773 = rewrite_clj.zip.base.tag(zloc);
var G__23773__$1 = (((G__23773 instanceof cljs.core.Keyword))?G__23773.fqn:null);
switch (G__23773__$1) {
case "token":
return rewrite_clj.zip.editz.edit_token(zloc,(function (p1__23771_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(s),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__23771_SHARP_)].join('');
}));
...
return cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(lines,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0)], null),(function (p1__23772_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(s),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__23772_SHARP_)].join('');
}));
}
}));
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__23773__$1)].join('')));

}
});
rewrite_clj.zip.editz.suffix = (function rewrite_clj$zip$editz$suffix(zloc,s){
var G__23775 = rewrite_clj.zip.base.tag(zloc);
var G__23775__$1 = (((G__23775 instanceof cljs.core.Keyword))?G__23775.fqn:null);
switch (G__23775__$1) {
case "token":
return rewrite_clj.zip.editz.edit_token(zloc,(function (p1__23774_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__23774_SHARP_),cljs.core.str.cljs$core$IFn$_invoke$arity$1(s)].join('');
}));
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__23775__$1)].join('')));
