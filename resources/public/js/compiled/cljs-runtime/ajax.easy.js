...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first(format),(function (){var G__32737 = cljs.core.second(format);
var G__32738 = format_params;
return (ajax.easy.keyword_response_format_element.cljs$core$IFn$_invoke$arity$2 ? ajax.easy.keyword_response_format_element.cljs$core$IFn$_invoke$arity$2(G__32737,G__32738) : ajax.easy.keyword_response_format_element.call(null,G__32737,G__32738));
})()], null);
} else {
if(cljs.core.map_QMARK_(format)){
return format;
...
if(cljs.core.vector_QMARK_(format)){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.vector,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__32740_SHARP_){
return ajax.easy.keyword_response_format_element(p1__32740_SHARP_,format_params);
}),format));
} else {
 ...
 */
ajax.easy.transform_handler = (function ajax$easy$transform_handler(p__32741){
...
var error_handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32742__$1,new cljs.core.Keyword(null,"error-handler","error-handler",-484945776));
var finally$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32742__$1,new cljs.core.Keyword(null,"finally","finally",1589088705));
...
return (function ajax$easy$transform_handler_$_easy_handler(p__32743){
var vec__32744 = p__32743;
var ok = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32744,(0),null);
var result = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32744,(1),null);
var fexpr__32747_32753 = (cljs.core.truth_(ok)?h:e);
(fexpr__32747_32753.cljs$core$IFn$_invoke$arity$1 ? fexpr__32747_32753.cljs$core$IFn$_invoke$arity$1(result) : fexpr__32747_32753.call(null,result));
...
ajax.easy.transform_opts = (function ajax$easy$transform_opts(p__32748){
var map__32749 = p__32748;
var map__32749__$1 = cljs.core.__destructure_map(map__32749);
var opts = map__32749__$1;
var method = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32749__$1,new cljs.core.Keyword(null,"method","method",55703592));
var format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32749__$1,new cljs.core.Keyword(null,"format","format",-1306924766));
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32749__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
var params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32749__$1,new cljs.core.Keyword(null,"params","params",710516235));
var body = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32749__$1,new cljs.core.Keyword(null,"body","body",-2049205669));
