...
var G__32729 = format;
var G__32729__$1 = (((G__32729 instanceof cljs.core.Keyword))?G__32729.fqn:null);
switch (G__32729__$1) {
case "transit":
return ajax.transit.transit_request_format.cljs$core$IFn$_invoke$arity$1(format_params);
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first(format),(function (){var G__32730 = cljs.core.second(format);
var G__32731 = format_params;
return (ajax.easy.keyword_response_format_element.cljs$core$IFn$_invoke$arity$2 ? ajax.easy.keyword_response_format_element.cljs$core$IFn$_invoke$arity$2(G__32730,G__32731) : ajax.easy.keyword_response_format_element.call(null,G__32730,G__32731));
})()], null);
} else {
if(cljs.core.map_QMARK_(format)){
return format;
...
if(cljs.core.vector_QMARK_(format)){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.vector,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__32735_SHARP_){
return ajax.easy.keyword_response_format_element(p1__32735_SHARP_,format_params);
}),format));
} else {
 ...
 */
ajax.easy.transform_handler = (function ajax$easy$transform_handler(p__32739){
var map__32740 = p__32739;
var map__32740__$1 = cljs.core.__destructure_map(map__32740);
var handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32740__$1,new cljs.core.Keyword(null,"handler","handler",-195596612));
var error_handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32740__$1,new cljs.core.Keyword(null,"error-handler","error-handler",-484945776));
var finally$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32740__$1,new cljs.core.Keyword(null,"finally","finally",1589088705));
var h = (function (){var or__5043__auto__ = handler;
...
var e = (function (){var or__5043__auto__ = error_handler;
if(cljs.core.truth_(or__5043__auto__)){
return or__5043__auto__;
} else {
...
return (function ajax$easy$transform_handler_$_easy_handler(p__32741){
var vec__32742 = p__32741;
var ok = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32742,(0),null);
var result = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32742,(1),null);
var fexpr__32745_32751 = (cljs.core.truth_(ok)?h:e);
(fexpr__32745_32751.cljs$core$IFn$_invoke$arity$1 ? fexpr__32745_32751.cljs$core$IFn$_invoke$arity$1(result) : fexpr__32745_32751.call(null,result));
...
ajax.easy.transform_opts = (function ajax$easy$transform_opts(p__32746){
var map__32747 = p__32746;
var map__32747__$1 = cljs.core.__destructure_map(map__32747);
var opts = map__32747__$1;
var method = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32747__$1,new cljs.core.Keyword(null,"method","method",55703592));
var format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32747__$1,new cljs.core.Keyword(null,"format","format",-1306924766));
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32747__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
var params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32747__$1,new cljs.core.Keyword(null,"params","params",710516235));
var body = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32747__$1,new cljs.core.Keyword(null,"body","body",-2049205669));

var needs_format = (((body == null)) && (cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(method,"GET")));
var rf = (cljs.core.truth_((function (){var or__5043__auto__ = format;
if(cljs.core.truth_(or__5043__auto__)){
return or__5043__auto__;
} else {
return needs_format;
