...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__15671 = c;
var G__15671__$1 = (((G__15671 == null))?null:G__15671.prototype);
if((G__15671__$1 == null)){
return null;
} else {
return G__15671__$1.reagentRender;
}
})() == null)))));
});
...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__15674 = c;
var G__15674__$1 = (((G__15674 == null))?null:G__15674.prototype);
if((G__15674__$1 == null)){
return null;
} else {
return G__15674__$1.render;
}
})() == null)))));
});
...
var or__5043__auto__ = (function (){var G__15677 = c;
var G__15677__$1 = (((G__15677 == null))?null:G__15677.constructor);
if((G__15677__$1 == null)){
return null;
} else {
return G__15677__$1.displayName;
}
})();
...
var G__15678 = c;
var G__15678__$1 = (((G__15678 == null))?null:G__15678.constructor);
if((G__15678__$1 == null)){
return null;
} else {
return G__15678__$1.name;
}
}
});
...
var _STAR_current_component_STAR__orig_val__15679 = day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__15680 = c;
(day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__15680);
...
}finally {(day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__15679);
}});
...
var or__5043__auto__ = day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.impl.util._STAR_always_update_STAR_;
if(cljs.core.truth_(or__5043__auto__)){
return or__5043__auto__;
} else {
var c = this;
...
var c = this;
var G__15683_15718 = day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.impl.component.goog$module$goog$object.get(c,"cljsRatom");
if((G__15683_15718 == null)){
} else {
day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.dispose_BANG_(G__15683_15718);
}
...
var renders_15719 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_15720 = cljs.core.first(cljs.core.vals(renders_15719));
...
if((cljs.core.count(renders_15719) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_15719))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_15720)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_15720], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var or__5043__auto____$1 = day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.impl.util.fun_name(render_fun);
...
var G__15684 = o;
day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.impl.component.goog$module$goog$object.set(G__15684,cljs.core.name(k),v);
...
while (G__15744__i < G__15744__a.length) {G__15744__a[G__15744__i] = arguments[G__15744__i + 0]; ++G__15744__i;}
  args = new cljs.core.IndexedSeq(G__15744__a,0,null);
} 
return G__15743__delegate.call(this,args);};
G__15743.cljs$lang$maxFixedArity = 0;
G__15743.cljs$lang$applyTo = (function (arglist__15749){
...
var _STAR_current_component_STAR__orig_val__15691 = day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__15692 = c;
(day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__15692);
...
}finally {(day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__15691);
}});
...
var vec__15693 = module$node_modules$react$index.useState((0));
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15693,(0),null);
var update_count = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15693,(1),null);
...
var G__15696 = day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.impl.component.goog$module$goog$object.get(reagent_state,"cljsRatom");
if((G__15696 == null)){
return null;
} else {
return day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.dispose_BANG_(G__15696);
}
});
}),[]);
...
var and__5041__auto__ = day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.impl.util._STAR_always_update_STAR_ === false;
if(and__5041__auto__){
try{return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(old_argv,new_argv);
}catch (e15697){var e = e15697;
if(day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.debug.has_console){
((day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.debug.tracking)?day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.debug.track_console:console).warn(["Warning: ","Exception thrown while comparing argv's in shouldComponentUpdate: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(old_argv)," ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(new_argv)," ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(e)].join(''));
} else {
}
...
var or__5043__auto__ = day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.impl.component.cached_react_class(compiler,tag);
if(cljs.core.truth_(or__5043__auto__)){
return or__5043__auto__;
} else {
