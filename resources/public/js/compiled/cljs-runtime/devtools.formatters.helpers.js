...
var G__14651 = devtools.prefs.pref(v);
v = G__14651;
continue;
} else {
return v;
...
}catch (e14594){var _e__11912__auto__ = e14594;
return false;
}})();
...
}catch (e14597){var _e__11912__auto__ = e14597;
return false;
}})();
...
}catch (e14599){var _e__11912__auto__ = e14599;
return false;
}}
}
});
...
var vec__14607 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14607,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14607,(1),null);
...
return cljs.core.some((function (p1__14613_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__14613_SHARP_);
}),template);
});
