...
}catch (e15319){var _e__11912__auto__ = e15319;
return false;
...
}catch (e15321){var _e__11912__auto__ = e15321;
return false;
...
}catch (e15323){var _e__11912__auto__ = e15323;
return false;
...
}catch (e15328){var _e__11912__auto__ = e15328;
return false;
...
}catch (e15333){var _e__11912__auto__ = e15333;
return false;
}})())){
...
}catch (e15335){var _e__11912__auto__ = e15335;
return false;
}})())){
...
var _STAR_current_state_STAR__orig_val__15340 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__15341 = (function (){var or__5043__auto__ = config;
if(cljs.core.truth_(or__5043__auto__)){
return or__5043__auto__;
} else {
...
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__15341);

try{return (raw_fn.cljs$core$IFn$_invoke$arity$1 ? raw_fn.cljs$core$IFn$_invoke$arity$1(value) : raw_fn.call(null,value));
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__15340);
}});
});
...
while (G__15350__i < G__15350__a.length) {G__15350__a[G__15350__i] = arguments[G__15350__i + 0]; ++G__15350__i;}
  args = new cljs.core.IndexedSeq(G__15350__a,0,null);
} 
