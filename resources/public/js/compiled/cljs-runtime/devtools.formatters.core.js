...
}catch (e15309){var _e__11847__auto__ = e15309;
return false;
...
}catch (e15314){var _e__11847__auto__ = e15314;
return false;
...
}catch (e15319){var _e__11847__auto__ = e15319;
return false;
...
}catch (e15321){var _e__11847__auto__ = e15321;
return false;
...
}catch (e15326){var _e__11847__auto__ = e15326;
return false;
}})())){
...
}catch (e15328){var _e__11847__auto__ = e15328;
return false;
}})())){
...
var _STAR_current_state_STAR__orig_val__15330 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__15331 = (function (){var or__5043__auto__ = config;
if(cljs.core.truth_(or__5043__auto__)){
return or__5043__auto__;
} else {
...
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__15331);

try{return (raw_fn.cljs$core$IFn$_invoke$arity$1 ? raw_fn.cljs$core$IFn$_invoke$arity$1(value) : raw_fn.call(null,value));
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__15330);
}});
});
...
while (G__15340__i < G__15340__a.length) {G__15340__a[G__15340__i] = arguments[G__15340__i + 0]; ++G__15340__i;}
  args = new cljs.core.IndexedSeq(G__15340__a,0,null);
} 
