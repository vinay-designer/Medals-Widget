...
zprint.finish.no_style_map = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"f","f",-1597136552),(function (p1__22021_SHARP_){
if(cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__22021_SHARP_,new cljs.core.Keyword(null,"none","none",1333468478))){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"reverse","reverse",-888455266)], null),p1__22021_SHARP_);
} else {
 ...
 */
zprint.finish.within_QMARK_ = (function zprint$finish$within_QMARK_(n,p__22022){
var vec__22023 = p__22022;
var low = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22023,(0),null);
var high = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22023,(1),null);
return (((n >= low)) && ((n <= high)));
});
/**
 ...
 */
zprint.finish.ground_color_to_style = (function zprint$finish$ground_color_to_style(p__22026,s,color,element,idx){
var map__22027 = p__22026;
var map__22027__$1 = cljs.core.__destructure_map(map__22027);
var style_map = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22027__$1,new cljs.core.Keyword(null,"style-map","style-map",1488693527));
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22027__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var select = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22027__$1,new cljs.core.Keyword(null,"select","select",1147833503));
...
var G__22030 = (function (){var or__5043__auto__ = color;
...
var fexpr__22029 = (function (){var G__22031 = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(element,new cljs.core.Keyword(null,"cursor-element","cursor-element",-616791907)))?(function (){
...
return (style_map.cljs$core$IFn$_invoke$arity$1 ? style_map.cljs$core$IFn$_invoke$arity$1(G__22031) : style_map.call(null,G__22031));
})();
return (fexpr__22029.cljs$core$IFn$_invoke$arity$1 ? fexpr__22029.cljs$core$IFn$_invoke$arity$1(G__22030) : fexpr__22029.call(null,G__22030));
} else {
return null;
}
});
 ...
 */
zprint.finish.add_length = (function zprint$finish$add_length(p__22032){
var vec__22033 = p__22032;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22033,(0),null);
var style = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22033,(1),null);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22033,(2),null);
 ...
 *   which are in focus.
 */
zprint.finish.gc_vec_to_style_vec = (function zprint$finish$gc_vec_to_style_vec(ctx,idx,p__22036){
var vec__22037 = p__22036;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22037,(0),null);
var keyword_color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22037,(1),null);
var element = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22037,(2),null);
...
var G__22104 = cljs.core.next(ssv);
var G__22105 = (this_ssv == null);
var G__22106 = (cljs.core.truth_(this_elide)?this_elide:last_elide);
var G__22107 = ((((doing_nil_QMARK_) && ((this_ssv == null))))?out:((((doing_nil_QMARK_) && ((!((this_ssv == null))))))?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,zprint.finish.gc_vec_to_style_vec(ctx,(0),this_elide)),zprint.finish.gc_vec_to_style_vec(ctx,(0),elide__$1)),this_ssv):(((this_ssv == null))?out:cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,this_ssv)
)));
ssv = G__22104;
doing_nil_QMARK_ = G__22105;
last_elide = G__22106;
out = G__22107;
continue;
}
...
var vec__22049 = cljs.core.first(remaining_cvec);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22049,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22049,(1),null);
var element_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22049,(2),null);
...
var G__22108 = cljs.core.next(remaining_cvec);
var G__22109 = new_idx;
var G__22110 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new_idx);
remaining_cvec = G__22108;
idx = G__22109;
out = G__22110;
continue;
}
 ...
 */
zprint.finish.replace_focus_w_cursor = (function zprint$finish$replace_focus_w_cursor(gcw_vec,p__22058,cursor_vec){
var vec__22059 = p__22058;
var focus_start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22059,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22059,(1),null);
var focus_vec = vec__22059;
...
var vec__22062 = cljs.core.split_at(focus_start,gcw_vec);
var front = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22062,(0),null);
var back = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22062,(1),null);
 ...
 */
zprint.finish.color_style = (function zprint$finish$color_style(p__22065){
var vec__22066 = p__22065;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22066,(0),null);
var color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22066,(1),null);
if((color == null)){
return s;
} else {
...
(zprint.finish.cursor_style.cljs$core$IFn$_invoke$arity$2 = (function (p__22072,existing_count){
var vec__22073 = p__22072;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22073,(0),null);
var cursor = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22073,(1),null);
...
return cljs.core.filterv((function (p1__22069_SHARP_){
return (!(cljs.core.empty_QMARK_(cljs.core.first(p1__22069_SHARP_))));
...
var vec__22080 = cljs.core.first(cvec_nl);
var n = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22080,(0),null);
var where = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22080,(1),null);
var cvec_element = vec__22080;
if((cvec_element == null)){
var G__22122 = cljs.core.next(cvec_nl);
var G__22123 = (idx + (1));
var G__22124 = start;
var G__22125 = out;
cvec_nl = G__22122;
...
var G__22126 = cljs.core.next(cvec_nl);
var G__22127 = (idx + (1));
var G__22128 = idx;
var G__22129 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null));
cvec_nl = G__22126;
idx = G__22127;
start = G__22128;
out = G__22129;
...
var G__22130 = cljs.core.next(cvec_nl);
var G__22131 = (idx + (1));
var G__22132 = (idx + (1));
var G__22133 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null));
cvec_nl = G__22130;
idx = G__22131;
start = G__22132;
out = G__22133;
...
var G__22134 = cljs.core.next(cvec_nl);
var G__22135 = (idx + (1));
var G__22136 = idx;
var G__22137 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null)),cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [idx,idx], null)));
cvec_nl = G__22134;
idx = G__22135;
start = G__22136;
out = G__22137;
...
var G__22138 = cljs.core.next(cvec_nl);
var G__22139 = (idx + (1));
var G__22140 = start;
var G__22141 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,out,cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null)));
cvec_nl = G__22138;
idx = G__22139;
start = G__22140;
out = G__22141;
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__22085_SHARP_,p2__22084_SHARP_){
if(zprint.finish.within_QMARK_(idx,p2__22084_SHARP_)){
return cljs.core.reduced(p1__22085_SHARP_);
} else {
return (p1__22085_SHARP_ + (1));
}
}),(0),lines);
});
/**
 ...
 */
zprint.finish.surround_focus = (function zprint$finish$surround_focus(lines_to_cvec,p__22086,p__22087){
var vec__22088 = p__22086;
var focus_begin = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22088,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22088,(1),null);
var vec__22091 = p__22087;
var before = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22091,(0),null);
var after = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22091,(1),null);
 ...
 */
zprint.finish.handle_lines = (function zprint$finish$handle_lines(p__22098,cvec,focus_vec){
var map__22099 = p__22098;
var map__22099__$1 = cljs.core.__destructure_map(map__22099);
var options = map__22099__$1;
var map__22100 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22099__$1,new cljs.core.Keyword(null,"output","output",-1105869043));
var map__22100__$1 = cljs.core.__destructure_map(map__22100);
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22100__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var lines = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22100__$1,new cljs.core.Keyword(null,"lines","lines",-700165781));
var paths = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22100__$1,new cljs.core.Keyword(null,"paths","paths",-1807389588));
...
var path_vecs__$1 = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__22096_SHARP_){
return zprint.finish.surround_focus(lines_to_cvec,p1__22096_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0),(0)], null));
}),path_vecs);
