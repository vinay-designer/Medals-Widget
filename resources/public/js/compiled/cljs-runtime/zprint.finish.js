...
zprint.finish.no_style_map = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"f","f",-1597136552),(function (p1__22035_SHARP_){
if(cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__22035_SHARP_,new cljs.core.Keyword(null,"none","none",1333468478))){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"reverse","reverse",-888455266)], null),p1__22035_SHARP_);
} else {
 ...
 */
zprint.finish.within_QMARK_ = (function zprint$finish$within_QMARK_(n,p__22040){
var vec__22041 = p__22040;
var low = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22041,(0),null);
var high = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22041,(1),null);
return (((n >= low)) && ((n <= high)));
});
/**
 ...
 */
zprint.finish.ground_color_to_style = (function zprint$finish$ground_color_to_style(p__22044,s,color,element,idx){
var map__22045 = p__22044;
var map__22045__$1 = cljs.core.__destructure_map(map__22045);
var style_map = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22045__$1,new cljs.core.Keyword(null,"style-map","style-map",1488693527));
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22045__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var select = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22045__$1,new cljs.core.Keyword(null,"select","select",1147833503));
...
var G__22048 = (function (){var or__5043__auto__ = color;
...
var fexpr__22047 = (function (){var G__22050 = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(element,new cljs.core.Keyword(null,"cursor-element","cursor-element",-616791907)))?(function (){
...
return (style_map.cljs$core$IFn$_invoke$arity$1 ? style_map.cljs$core$IFn$_invoke$arity$1(G__22050) : style_map.call(null,G__22050));
})();
return (fexpr__22047.cljs$core$IFn$_invoke$arity$1 ? fexpr__22047.cljs$core$IFn$_invoke$arity$1(G__22048) : fexpr__22047.call(null,G__22048));
} else {
return null;
}
});
 ...
 */
zprint.finish.add_length = (function zprint$finish$add_length(p__22051){
var vec__22052 = p__22051;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22052,(0),null);
var style = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22052,(1),null);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22052,(2),null);
 ...
 *   which are in focus.
 */
zprint.finish.gc_vec_to_style_vec = (function zprint$finish$gc_vec_to_style_vec(ctx,idx,p__22055){
var vec__22056 = p__22055;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22056,(0),null);
var keyword_color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22056,(1),null);
var element = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22056,(2),null);
...
var G__22122 = cljs.core.next(ssv);
var G__22123 = (this_ssv == null);
var G__22124 = (cljs.core.truth_(this_elide)?this_elide:last_elide);
var G__22125 = ((((doing_nil_QMARK_) && ((this_ssv == null))))?out:((((doing_nil_QMARK_) && ((!((this_ssv == null))))))?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,zprint.finish.gc_vec_to_style_vec(ctx,(0),this_elide)),zprint.finish.gc_vec_to_style_vec(ctx,(0),elide__$1)),this_ssv):(((this_ssv == null))?out:cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,this_ssv)
)));
ssv = G__22122;
doing_nil_QMARK_ = G__22123;
last_elide = G__22124;
out = G__22125;
continue;
}
...
var vec__22063 = cljs.core.first(remaining_cvec);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22063,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22063,(1),null);
var element_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22063,(2),null);
...
var G__22127 = cljs.core.next(remaining_cvec);
var G__22128 = new_idx;
var G__22129 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new_idx);
remaining_cvec = G__22127;
idx = G__22128;
out = G__22129;
continue;
}
 ...
 */
zprint.finish.replace_focus_w_cursor = (function zprint$finish$replace_focus_w_cursor(gcw_vec,p__22071,cursor_vec){
var vec__22072 = p__22071;
var focus_start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22072,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22072,(1),null);
var focus_vec = vec__22072;
...
var vec__22075 = cljs.core.split_at(focus_start,gcw_vec);
var front = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22075,(0),null);
var back = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22075,(1),null);
 ...
 */
zprint.finish.color_style = (function zprint$finish$color_style(p__22079){
var vec__22080 = p__22079;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22080,(0),null);
var color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22080,(1),null);
if((color == null)){
return s;
} else {
...
(zprint.finish.cursor_style.cljs$core$IFn$_invoke$arity$2 = (function (p__22087,existing_count){
var vec__22088 = p__22087;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22088,(0),null);
var cursor = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22088,(1),null);
...
return cljs.core.filterv((function (p1__22084_SHARP_){
return (!(cljs.core.empty_QMARK_(cljs.core.first(p1__22084_SHARP_))));
...
var vec__22099 = cljs.core.first(cvec_nl);
var n = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22099,(0),null);
var where = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22099,(1),null);
var cvec_element = vec__22099;
if((cvec_element == null)){
var G__22140 = cljs.core.next(cvec_nl);
var G__22141 = (idx + (1));
var G__22142 = start;
var G__22143 = out;
cvec_nl = G__22140;
...
var G__22145 = cljs.core.next(cvec_nl);
var G__22146 = (idx + (1));
var G__22147 = idx;
var G__22148 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null));
cvec_nl = G__22145;
idx = G__22146;
start = G__22147;
out = G__22148;
...
var G__22149 = cljs.core.next(cvec_nl);
var G__22150 = (idx + (1));
var G__22151 = (idx + (1));
var G__22152 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null));
cvec_nl = G__22149;
idx = G__22150;
start = G__22151;
out = G__22152;
...
var G__22153 = cljs.core.next(cvec_nl);
var G__22154 = (idx + (1));
var G__22155 = idx;
var G__22156 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null)),cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [idx,idx], null)));
cvec_nl = G__22153;
idx = G__22154;
start = G__22155;
out = G__22156;
...
var G__22157 = cljs.core.next(cvec_nl);
var G__22158 = (idx + (1));
var G__22159 = start;
var G__22160 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,out,cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null)));
cvec_nl = G__22157;
idx = G__22158;
start = G__22159;
out = G__22160;
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__22104_SHARP_,p2__22103_SHARP_){
if(zprint.finish.within_QMARK_(idx,p2__22103_SHARP_)){
return cljs.core.reduced(p1__22104_SHARP_);
} else {
return (p1__22104_SHARP_ + (1));
}
}),(0),lines);
});
/**
 ...
 */
zprint.finish.surround_focus = (function zprint$finish$surround_focus(lines_to_cvec,p__22106,p__22107){
var vec__22108 = p__22106;
var focus_begin = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22108,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22108,(1),null);
var vec__22111 = p__22107;
var before = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22111,(0),null);
var after = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22111,(1),null);
 ...
 */
zprint.finish.handle_lines = (function zprint$finish$handle_lines(p__22116,cvec,focus_vec){
var map__22117 = p__22116;
var map__22117__$1 = cljs.core.__destructure_map(map__22117);
var options = map__22117__$1;
var map__22118 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22117__$1,new cljs.core.Keyword(null,"output","output",-1105869043));
var map__22118__$1 = cljs.core.__destructure_map(map__22118);
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22118__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var lines = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22118__$1,new cljs.core.Keyword(null,"lines","lines",-700165781));
var paths = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22118__$1,new cljs.core.Keyword(null,"paths","paths",-1807389588));
...
var path_vecs__$1 = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__22115_SHARP_){
return zprint.finish.surround_focus(lines_to_cvec,p1__22115_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0),(0)], null));
}),path_vecs);
