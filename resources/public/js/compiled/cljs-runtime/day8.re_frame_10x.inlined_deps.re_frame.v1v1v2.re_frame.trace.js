...
day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.trace.start_trace = (function day8$re_frame_10x$inlined_deps$re_frame$v1v1v2$re_frame$trace$start_trace(p__16534){
var map__16535 = p__16534;
var map__16535__$1 = cljs.core.__destructure_map(map__16535);
var operation = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16535__$1,new cljs.core.Keyword(null,"operation","operation",-1267664310));
var op_type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16535__$1,new cljs.core.Keyword(null,"op-type","op-type",-1636141668));
var tags = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16535__$1,new cljs.core.Keyword(null,"tags","tags",1771418977));
var child_of = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16535__$1,new cljs.core.Keyword(null,"child-of","child-of",-903376662));
...
var seq__16536_16566 = cljs.core.seq(cljs.core.deref(day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.trace.trace_cbs));
var chunk__16537_16567 = null;
var count__16538_16568 = (0);
var i__16539_16569 = (0);
while(true){
if((i__16539_16569 < count__16538_16568)){
var vec__16550_16570 = chunk__16537_16567.cljs$core$IIndexed$_nth$arity$2(null,i__16539_16569);
var k_16571 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16550_16570,(0),null);
var cb_16572 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16550_16570,(1),null);
try{var G__16554_16573 = cljs.core.deref(day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.trace.traces);
(cb_16572.cljs$core$IFn$_invoke$arity$1 ? cb_16572.cljs$core$IFn$_invoke$arity$1(G__16554_16573) : cb_16572.call(null,G__16554_16573));
}catch (e16553){var e_16574 = e16553;
day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.loggers.console.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.Keyword(null,"error","error",-978969032),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["Error thrown from trace cb",k_16571,"while storing",cljs.core.deref(day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.trace.traces),e_16574], 0));
}

var G__16575 = seq__16536_16566;
var G__16576 = chunk__16537_16567;
var G__16577 = count__16538_16568;
var G__16578 = (i__16539_16569 + (1));
seq__16536_16566 = G__16575;
chunk__16537_16567 = G__16576;
count__16538_16568 = G__16577;
i__16539_16569 = G__16578;
continue;
} else {
var temp__5804__auto___16579 = cljs.core.seq(seq__16536_16566);
if(temp__5804__auto___16579){
var seq__16536_16580__$1 = temp__5804__auto___16579;
if(cljs.core.chunked_seq_QMARK_(seq__16536_16580__$1)){
var c__5565__auto___16581 = cljs.core.chunk_first(seq__16536_16580__$1);
var G__16582 = cljs.core.chunk_rest(seq__16536_16580__$1);
var G__16583 = c__5565__auto___16581;
var G__16584 = cljs.core.count(c__5565__auto___16581);
var G__16585 = (0);
seq__16536_16566 = G__16582;
chunk__16537_16567 = G__16583;
count__16538_16568 = G__16584;
i__16539_16569 = G__16585;
continue;
} else {
var vec__16555_16586 = cljs.core.first(seq__16536_16580__$1);
var k_16587 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16555_16586,(0),null);
var cb_16588 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16555_16586,(1),null);
try{var G__16559_16589 = cljs.core.deref(day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.trace.traces);
(cb_16588.cljs$core$IFn$_invoke$arity$1 ? cb_16588.cljs$core$IFn$_invoke$arity$1(G__16559_16589) : cb_16588.call(null,G__16559_16589));
}catch (e16558){var e_16590 = e16558;
day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.loggers.console.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.Keyword(null,"error","error",-978969032),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["Error thrown from trace cb",k_16587,"while storing",cljs.core.deref(day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.trace.traces),e_16590], 0));
}

var G__16591 = cljs.core.next(seq__16536_16580__$1);
var G__16592 = null;
var G__16593 = (0);
var G__16594 = (0);
seq__16536_16566 = G__16591;
chunk__16537_16567 = G__16592;
count__16538_16568 = G__16593;
i__16539_16569 = G__16594;
continue;
}
} else {
}
