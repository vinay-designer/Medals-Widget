...
var len__5766__auto___25624 = arguments.length;
var i__5767__auto___25625 = (0);
while(true){
if((i__5767__auto___25625 < len__5766__auto___25624)){
args__5772__auto__.push((arguments[i__5767__auto___25625]));

var G__25626 = (i__5767__auto___25625 + (1));
i__5767__auto___25625 = G__25626;
continue;
} else {
}
break;
...
(day8.re_frame_10x.panels.settings.views.closeable_text_box.cljs$core$IFn$_invoke$arity$variadic = (function (p__25593){
var map__25594 = p__25593;
var map__25594__$1 = cljs.core.__destructure_map(map__25594);
var model = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25594__$1,new cljs.core.Keyword(null,"model","model",331153215));
var width = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25594__$1,new cljs.core.Keyword(null,"width","width",-384071477));
var on_close = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25594__$1,new cljs.core.Keyword(null,"on-close","on-close",-761178394));
var on_change = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25594__$1,new cljs.core.Keyword(null,"on-change","on-change",-732046149));
...
/** @this {Function} */
(day8.re_frame_10x.panels.settings.views.closeable_text_box.cljs$lang$applyTo = (function (seq25591){
var self__5752__auto__ = this;
return self__5752__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq25591));
}));
...
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [day8.re_frame_10x.panels.settings.views.settings_box,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentVector(null, 7, 5, cljs.core.PersistentVector.EMPTY_NODE, [day8.re_frame_10x.components.re_com.checkbox,new cljs.core.Keyword(null,"model","model",331153215),follows_events_QMARK_,new cljs.core.Keyword(null,"label","label",1718410804),"sync app-db with epoch navigation",new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (p1__25606_SHARP_){
return day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.core.dispatch(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("day8.re-frame-10x.panels.settings.events","app-db-follows-events?","day8.re-frame-10x.panels.settings.events/app-db-follows-events?",-1040848496),p1__25606_SHARP_], null));
...
})], null)], null)], null),new cljs.core.PersistentVector(null, 7, 5, cljs.core.PersistentVector.EMPTY_NODE, [day8.re_frame_10x.components.re_com.v_box,new cljs.core.Keyword(null,"width","width",-384071477),day8.re_frame_10x.panels.settings.views.comp_section_width,new cljs.core.Keyword(null,"gap","gap",80255254),day8.re_frame_10x.panels.settings.views.vertical_gap,new cljs.core.Keyword(null,"children","children",-940561982),(function (){var iter__5520__auto__ = (function day8$re_frame_10x$panels$settings$views$render_$_iter__25616(s__25617){
return (new cljs.core.LazySeq(null,(function (){
var s__25617__$1 = s__25617;
while(true){
var temp__5804__auto__ = cljs.core.seq(s__25617__$1);
if(temp__5804__auto__){
var s__25617__$2 = temp__5804__auto__;
if(cljs.core.chunked_seq_QMARK_(s__25617__$2)){
var c__5518__auto__ = cljs.core.chunk_first(s__25617__$2);
var size__5519__auto__ = cljs.core.count(c__5518__auto__);
var b__25619 = cljs.core.chunk_buffer(size__5519__auto__);
if((function (){var i__25618 = (0);
while(true){
if((i__25618 < size__5519__auto__)){
var item = cljs.core._nth(c__5518__auto__,i__25618);
var id = new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(item);
cljs.core.chunk_append(b__25619,cljs.core.with_meta(new cljs.core.PersistentVector(null, 9, 5, cljs.core.PersistentVector.EMPTY_NODE, [day8.re_frame_10x.panels.settings.views.closeable_text_box,new cljs.core.Keyword(null,"model","model",331153215),new cljs.core.Keyword(null,"event-str","event-str",381347778).cljs$core$IFn$_invoke$arity$1(item),new cljs.core.Keyword(null,"width","width",-384071477),"212px",new cljs.core.Keyword(null,"on-close","on-close",-761178394),((function (i__25618,id,item,c__5518__auto__,size__5519__auto__,b__25619,s__25617__$2,temp__5804__auto__,ambiance){
return (function (){
...
});})(i__25618,id,item,c__5518__auto__,size__5519__auto__,b__25619,s__25617__$2,temp__5804__auto__,ambiance))
,new cljs.core.Keyword(null,"on-change","on-change",-732046149),((function (i__25618,id,item,c__5518__auto__,size__5519__auto__,b__25619,s__25617__$2,temp__5804__auto__,ambiance){
return (function (p1__25607_SHARP_){
return day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.core.dispatch(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("day8.re-frame-10x.panels.settings.events","update-ignored-event","day8.re-frame-10x.panels.settings.events/update-ignored-event",789804124),id,p1__25607_SHARP_], null));
});})(i__25618,id,item,c__5518__auto__,size__5519__auto__,b__25619,s__25617__$2,temp__5804__auto__,ambiance))
], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),id], null)));

var G__25627 = (i__25618 + (1));
i__25618 = G__25627;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__25619),day8$re_frame_10x$panels$settings$views$render_$_iter__25616(cljs.core.chunk_rest(s__25617__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__25619),null);
}
} else {
var item = cljs.core.first(s__25617__$2);
var id = new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(item);
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 9, 5, cljs.core.PersistentVector.EMPTY_NODE, [day8.re_frame_10x.panels.settings.views.closeable_text_box,new cljs.core.Keyword(null,"model","model",331153215),new cljs.core.Keyword(null,"event-str","event-str",381347778).cljs$core$IFn$_invoke$arity$1(item),new cljs.core.Keyword(null,"width","width",-384071477),"212px",new cljs.core.Keyword(null,"on-close","on-close",-761178394),((function (id,item,s__25617__$2,temp__5804__auto__,ambiance){
return (function (){
return day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.core.dispatch(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("day8.re-frame-10x.panels.settings.events","remove-ignored-event","day8.re-frame-10x.panels.settings.events/remove-ignored-event",252246704),id], null));
});})(id,item,s__25617__$2,temp__5804__auto__,ambiance))
,new cljs.core.Keyword(null,"on-change","on-change",-732046149),((function (id,item,s__25617__$2,temp__5804__auto__,ambiance){
return (function (p1__25607_SHARP_){
return day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.core.dispatch(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("day8.re-frame-10x.panels.settings.events","update-ignored-event","day8.re-frame-10x.panels.settings.events/update-ignored-event",789804124),id,p1__25607_SHARP_], null));
});})(id,item,s__25617__$2,temp__5804__auto__,ambiance))
], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),id], null)),day8$re_frame_10x$panels$settings$views$render_$_iter__25616(cljs.core.rest(s__25617__$2)));
}
} else {
return null;
}
...
})], null)], null)], null),new cljs.core.PersistentVector(null, 7, 5, cljs.core.PersistentVector.EMPTY_NODE, [day8.re_frame_10x.components.re_com.v_box,new cljs.core.Keyword(null,"width","width",-384071477),day8.re_frame_10x.panels.settings.views.comp_section_width,new cljs.core.Keyword(null,"gap","gap",80255254),day8.re_frame_10x.panels.settings.views.vertical_gap,new cljs.core.Keyword(null,"children","children",-940561982),(function (){var iter__5520__auto__ = (function day8$re_frame_10x$panels$settings$views$render_$_iter__25620(s__25621){
return (new cljs.core.LazySeq(null,(function (){
var s__25621__$1 = s__25621;
while(true){
var temp__5804__auto__ = cljs.core.seq(s__25621__$1);
if(temp__5804__auto__){
var s__25621__$2 = temp__5804__auto__;
if(cljs.core.chunked_seq_QMARK_(s__25621__$2)){
var c__5518__auto__ = cljs.core.chunk_first(s__25621__$2);
var size__5519__auto__ = cljs.core.count(c__5518__auto__);
var b__25623 = cljs.core.chunk_buffer(size__5519__auto__);
if((function (){var i__25622 = (0);
while(true){
if((i__25622 < size__5519__auto__)){
var item = cljs.core._nth(c__5518__auto__,i__25622);
var id = new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(item);
cljs.core.chunk_append(b__25623,cljs.core.with_meta(new cljs.core.PersistentVector(null, 9, 5, cljs.core.PersistentVector.EMPTY_NODE, [day8.re_frame_10x.panels.settings.views.closeable_text_box,new cljs.core.Keyword(null,"model","model",331153215),new cljs.core.Keyword(null,"ns-str","ns-str",-2062616499).cljs$core$IFn$_invoke$arity$1(item),new cljs.core.Keyword(null,"width","width",-384071477),"343px",new cljs.core.Keyword(null,"on-close","on-close",-761178394),((function (i__25622,id,item,c__5518__auto__,size__5519__auto__,b__25623,s__25621__$2,temp__5804__auto__,ambiance){
return (function (){
...
});})(i__25622,id,item,c__5518__auto__,size__5519__auto__,b__25623,s__25621__$2,temp__5804__auto__,ambiance))
,new cljs.core.Keyword(null,"on-change","on-change",-732046149),((function (i__25622,id,item,c__5518__auto__,size__5519__auto__,b__25623,s__25621__$2,temp__5804__auto__,ambiance){
return (function (p1__25608_SHARP_){
return day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.core.dispatch(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("day8.re-frame-10x.panels.settings.events","update-filtered-view-trace","day8.re-frame-10x.panels.settings.events/update-filtered-view-trace",598201221),id,p1__25608_SHARP_], null));
});})(i__25622,id,item,c__5518__auto__,size__5519__auto__,b__25623,s__25621__$2,temp__5804__auto__,ambiance))
], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),id], null)));

var G__25628 = (i__25622 + (1));
i__25622 = G__25628;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__25623),day8$re_frame_10x$panels$settings$views$render_$_iter__25620(cljs.core.chunk_rest(s__25621__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__25623),null);
}
} else {
var item = cljs.core.first(s__25621__$2);
var id = new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(item);
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 9, 5, cljs.core.PersistentVector.EMPTY_NODE, [day8.re_frame_10x.panels.settings.views.closeable_text_box,new cljs.core.Keyword(null,"model","model",331153215),new cljs.core.Keyword(null,"ns-str","ns-str",-2062616499).cljs$core$IFn$_invoke$arity$1(item),new cljs.core.Keyword(null,"width","width",-384071477),"343px",new cljs.core.Keyword(null,"on-close","on-close",-761178394),((function (id,item,s__25621__$2,temp__5804__auto__,ambiance){
return (function (){
return day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.core.dispatch(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("day8.re-frame-10x.panels.settings.events","remove-filtered-view-trace","day8.re-frame-10x.panels.settings.events/remove-filtered-view-trace",2058604246),id], null));
});})(id,item,s__25621__$2,temp__5804__auto__,ambiance))
,new cljs.core.Keyword(null,"on-change","on-change",-732046149),((function (id,item,s__25621__$2,temp__5804__auto__,ambiance){
return (function (p1__25608_SHARP_){
return day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.core.dispatch(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("day8.re-frame-10x.panels.settings.events","update-filtered-view-trace","day8.re-frame-10x.panels.settings.events/update-filtered-view-trace",598201221),id,p1__25608_SHARP_], null));
});})(id,item,s__25621__$2,temp__5804__auto__,ambiance))
], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),id], null)),day8$re_frame_10x$panels$settings$views$render_$_iter__25620(cljs.core.rest(s__25621__$2)));
}
} else {
return null;
}
...
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [day8.re_frame_10x.panels.settings.views.settings_box,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [day8.re_frame_10x.components.re_com.label,new cljs.core.Keyword(null,"label","label",1718410804),"Remove low level trace"], null),new cljs.core.PersistentVector(null, 7, 5, cljs.core.PersistentVector.EMPTY_NODE, [day8.re_frame_10x.components.re_com.checkbox,new cljs.core.Keyword(null,"model","model",331153215),new cljs.core.Keyword(null,"reagent","reagent",2131627322).cljs$core$IFn$_invoke$arity$1(low_level_trace),new cljs.core.Keyword(null,"label","label",1718410804),"reagent internals",new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (p1__25609_SHARP_){
return day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.core.dispatch(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("day8.re-frame-10x.panels.settings.subs","low-level-trace","day8.re-frame-10x.panels.settings.subs/low-level-trace",-929378536),new cljs.core.Keyword(null,"reagent","reagent",2131627322),p1__25609_SHARP_], null));
})], null),new cljs.core.PersistentVector(null, 7, 5, cljs.core.PersistentVector.EMPTY_NODE, [day8.re_frame_10x.components.re_com.checkbox,new cljs.core.Keyword(null,"model","model",331153215),new cljs.core.Keyword(null,"re-frame","re-frame",-1039473033).cljs$core$IFn$_invoke$arity$1(low_level_trace),new cljs.core.Keyword(null,"label","label",1718410804),"re-frame internals",new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (p1__25610_SHARP_){
return day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.core.dispatch(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("day8.re-frame-10x.panels.settings.subs","low-level-trace","day8.re-frame-10x.panels.settings.subs/low-level-trace",-929378536),new cljs.core.Keyword(null,"re-frame","re-frame",-1039473033),p1__25610_SHARP_], null));
...
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [day8.re_frame_10x.panels.settings.views.settings_box,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentVector(null, 7, 5, cljs.core.PersistentVector.EMPTY_NODE, [day8.re_frame_10x.components.re_com.checkbox,new cljs.core.Keyword(null,"model","model",331153215),open_inspectors_QMARK_,new cljs.core.Keyword(null,"label","label",1718410804),"open new inspectors by default",new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (p1__25611_SHARP_){
return day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.core.dispatch(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("day8.re-frame-10x.panels.settings.events","open-new-inspectors?","day8.re-frame-10x.panels.settings.events/open-new-inspectors?",-1146109198),p1__25611_SHARP_], null));
